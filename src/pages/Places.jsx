...
const Places = () => {
  ...
  const classifications = [...new Set(places.map(place => place.classification))];
  const cities = [...new Set(places.map(place => place.city))];

  const filteredPlaces = places.filter(place => {
    const matchesSearch = place.name.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesClassification = selectedClassification === '' || place.classification === selectedClassification;
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Explore the wonders of Egypt - from ancient pyramids to modern marvels, find your perfect destination
          </motion.p>
        </motion.div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex-1">
              <div className="relative">
                <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-500 text-xl">🔍</span>
                <input
                  type="text"
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <div className="relative">
                <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-500 text-lg">🏷️</span>
                <select
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-500 text-lg">📍</span>
                <select
                  value={selectedCity}
              ...
              <Link to={`/place/${place.id}`} className="block group">
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500 font-medium">Click to explore</span>
                    <span className="text-blue-500 group-hover:text-blue-700 transition-colors text-xl">→</span>
                  </div>
                </div>
              </div>
            </Link>
